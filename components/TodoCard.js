    ...
    return (
        <div className='p-2 relative sm:p-3 border flex items-stretch border-white border-solid '>
            ...
            <div className='flex items-center'>
                {(edit === todoKey) ? <i onClick={handleEditTodo} className="fa-solid fa-circle-check px-2 duration-300 hover:scale-125 cursor-pointer"></i> : <i onClick={handleAddEdit(todoKey)} className="fa-solid fa-circle px-2 duration-300 hover:rotate-45 cursor-pointer"></i>}
